...
class EditReservationFragment: Fragment(R.layout.edit_reservation_fragment) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        reservations.observe(viewLifecycleOwner) {
            ...
            it.forEach { r ->
                if (r.time.year==myReservation.time.year && r.time.month==myReservation.time.month && r.time.dayOfMonth==myReservation.time.dayOfMonth ) {
            ...
            playgrounds.observe(viewLifecycleOwner) {
                ...
                val listView = view.findViewById<ListView>(R.id.listViewHours)
